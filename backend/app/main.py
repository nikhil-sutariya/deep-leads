...
from app.api import leads, campaigns, auth, enums, dashboard, tracking, saved_searches
...
app.include_router(saved_searches.router, tags=['Saved Searches'], prefix='/api/v1/saved-searches')
